package com.marbleArchPaint.start;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
       ...
       System.out.println("rootDir is : "+rootDir);
		 ...
		 */
		rootDir = "file:" + rootDir + "/marbleArchPaint;hsqldb.default_table_type=cached;sql.enforce_strict_size=true";
		
		HsqlProperties p = new HsqlProperties();
		p.setProperty("server.database.0", rootDir);
		p.setProperty("server.dbname.0",  "marbleArchPaint");
