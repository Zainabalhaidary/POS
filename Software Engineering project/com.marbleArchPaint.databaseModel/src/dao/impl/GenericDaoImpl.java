...
public class GenericDaoImpl extends EObjectImpl implements GenericDao {
	...
	public void create(Object object) {
		...
		{
			OrderDetails od = (OrderDetails) object;
			
			Order o = od.getOrderId();
			session.refresh(o);
		}
		if(object instanceof Order)
		{
			...
			User u = o.getSalesPerson();
			session.refresh(u);
		}
		if(object instanceof Product)
		{
			Product p = (Product) object;
			Category c = (Category) p.getCatergoryId();
			session.refresh(c);
		}
	...
	public void update(Object object) {
		...
		session.saveOrUpdate(object);
//		System.out.println("I arrived to the saveorUpdate");

		try {

			session.getTransaction().commit();
//			System.out.println("commit is successful");
	...
	public void retrieve() {
		...
		session.beginTransaction();
		//		String string = "from Container where deleted =true";
		//		Query queryRes = session.createQuery(string);
		//		List resultList = queryRes.list();
		//		for(Object c:resultList)
		//		{
		//		general.Container myContainer =(general.Container)c;
		//		String name = myContainer.getName();
		String hqlUpdate = "update Entity set deleted = :false where deleted = :true";
	...
	public List<?> getByQuery(String string) {
		//		System.err.println( "I'm in get bey query");
		session = getSession();
		session.beginTransaction();
		Query queryRes = session.createQuery(string);
