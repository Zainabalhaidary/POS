 ...
 * <ul>
 *   <li>{@link general.impl.CategoryImpl#getCategoryId <em>Category Id</em>}</li>
 *   <li>{@link general.impl.CategoryImpl#getCategoryName <em>Category Name</em>}</li>
 *   <li>{@link general.impl.CategoryImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CategoryImpl extends EObjectImpl implements Category {
	...
	protected EClass eStaticClass() {
		return GeneralPackage.Literals.CATEGORY;
	}
	...
	public void setCategoryId(String newCategoryId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneralPackage.CATEGORY__CATEGORY_ID, oldCategoryId, categoryId));
	}
	...
	public void setCategoryName(String newCategoryName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneralPackage.CATEGORY__CATEGORY_NAME, oldCategoryName, categoryName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneralPackage.CATEGORY__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GeneralPackage.CATEGORY__CATEGORY_ID:
				return getCategoryId();
			case GeneralPackage.CATEGORY__CATEGORY_NAME:
				return getCategoryName();
			case GeneralPackage.CATEGORY__DESCRIPTION:
