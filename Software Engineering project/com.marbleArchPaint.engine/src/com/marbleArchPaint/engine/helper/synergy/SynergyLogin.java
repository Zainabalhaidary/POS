...
public class SynergyLogin {
	...
	public long session_close_time;
...
//	private String ccmIniFile = "\"%userprofile%\\ccm71.ini\"";
	...
	public void closeSynergySession( String sessionID) {
		...
		try {
			...
			session_close_time = (end-start)/1000;
	...
	public String getSynergySessionId() {
		...
		System.out.println("Session start time was "+ 
				(end1-start)/1000+" s.");
//		log.warn("Synergy Session start time was "+ (end1-start)/1000+" s.");
		session_start_time =(end1-start)/1000;
		return sessionID;
	}
...
//				System.out.println("the whole result set is "+ resultset.toString());
