...
public class MksLogin {
	...
	public MksLogin ( String username, String password, String database, boolean isSandbox,int port) {
	...
	public List<String> showProjects() {
		System.out.println("db is "+database);
//		if(database.equals("mks-bs"))
//			port=7001;
//		else
//			if(database.equals("mks-bs-test"))
//				port=8401;
