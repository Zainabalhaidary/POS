...
//	private int port;
	...
	public MksGetFile ( Connection connection1, File file1, 
		...
		System.out.print("openFile().substring(9);"+openFile().substring(9));
...
//					port=8401;
			...
			System.out.println("connection.getPassword() "+connection.getPassword());
...
//			myCmd.addOption( new Option( "project" , connection.getProject() ) );
			...
			if(connection.getDatabase().equals("mks-bs-test"))
			{
//			myCmd.addOption(new Option("hostname","mks-bs-test"));
			myCmd.addOption(new Option("port","8401"));
			myCmd.addOption(new Option("user",connection.getUsername()));
			myCmd.addOption(new Option("password",connection.getPassword()));
			}
	...
	private void openLocalFile() {
		...
		System.out.print("cmd /C \"" + fileName.substring(9) + "\"");
		try {
