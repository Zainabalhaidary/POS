...
//		configurer.setShowPerspectiveBar(true);
		...
		configurer.setTitle("Marble Arch Paint");
	...
	private TrayItem initTaskItem(IWorkbenchWindow window) {
		...
		try{
		trayImage = Activator.getImageDescriptor("icons/product/startup_16_32.png").createImage();
		...
		trayItem.setToolTipText("Marble Arch Paint");
		return trayItem;
